/**
 * Merge redundant Blue Moon expense subcategories into numbered targets.
 *
 * Default: dry-run (preview only)
 * Apply:   node server/scripts/mergeBlueMoonExpenseSubs.cjs --apply
 *
 * Scope: BRANCH_ID for Blue Moon only. Does not change EXP_AMOUNT values.
 */
...
const MERGES = [
	// Unnumbered duplicate → numbered Food Supplies
	{
		sourceMain: FOOD_SUPPLIES,
		sourceName: '오일, 소스, 조미료 / Oil, Sauce, Seasoning',
		targetMain: FOOD_SUPPLIES,
		targetName: '1. 오일, 소스, 조미료 / Oil, Sauce, Seasoning',
	},
	// Misnumbered combo → closest numbered beverages
	{
		sourceMain: FOOD_SUPPLIES,
		sourceName: '9. 음료 / Beverages, Fresh Food',
		targetMain: FOOD_SUPPLIES,
		targetName: '9. 음료 / Beverages',
	},
	// Supplies under Food Supplies → Operation numbered Supplies
	{
		sourceMain: FOOD_SUPPLIES,
